/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc` (hash: cdea5ec68e06f6d56bd8349db0253245)
// Runtime types generated with workerd@1.20260210.0 2025-08-15 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SumUpMcpAgent";
	}
	interface DevEnv {
		HOST: "https://mcp-theta.sam-app.ro";
		SUMUP_API_HOST: "https://api-theta.sam-app.ro";
		SUMUP_AUTH_HOST: "https://auth-theta.sam-app.ro";
		SUMUP_MCP_AGENT: DurableObjectNamespace<import("./src/worker").SumUpMcpAgent>;
	}
	interface StageEnv {
		HOST: "https://mcp.sam-app.ro";
		SUMUP_API_HOST: "https://api.sam-app.ro";
		SUMUP_AUTH_HOST: "https://auth.sam-app.ro";
		SUMUP_MCP_AGENT: DurableObjectNamespace<import("./src/worker").SumUpMcpAgent>;
	}
	interface LiveEnv {
		HOST: "https://mcp.sumup.com";
		SUMUP_API_HOST: "https://api.sumup.com";
		SUMUP_AUTH_HOST: "https://auth.sumup.com";
		SUMUP_MCP_AGENT: DurableObjectNamespace<import("./src/worker").SumUpMcpAgent>;
	}
	interface Env {
		HOST?: "https://mcp-theta.sam-app.ro" | "https://mcp.sam-app.ro" | "https://mcp.sumup.com";
		SUMUP_API_HOST?: "https://api-theta.sam-app.ro" | "https://api.sam-app.ro" | "https://api.sumup.com";
		SUMUP_AUTH_HOST?: "https://auth-theta.sam-app.ro" | "https://auth.sam-app.ro" | "https://auth.sumup.com";
		SUMUP_MCP_AGENT: DurableObjectNamespace<import("./src/worker").SumUpMcpAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOST" | "SUMUP_API_HOST" | "SUMUP_AUTH_HOST">> {}
}
